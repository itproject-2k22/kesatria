...
export default function MateriPage(){
    ...
    const Transtition=()=>{
        return(
            <>
            <Image
            className="absolute w-[100vw] top-0 max-lg:hidden"
            alt=""
            ...
            />
            <Image
            className="absolute w-[100vw] top-0 left-0 max-lg:hidden"
            alt=""
            ...
            />
            <Image
            className="absolute w-[100vw] top-0 right-0 max-lg:hidden"
            alt=""
            ...
            />
            <Image
            className="absolute w-[100vw] top-0 lg:hidden"
            alt=""
    ...
    return(
        <main 
        className="min-w-screen min-h-screen bg-[url('/images/background/Background_beranda.svg')] bg-repeat bg-[size:25%] flex flex-col items-center place-content-center gap-[5vw] py-[15vw] overflow-hidden hide-scrollbar"
        >
            <Transtition/>
            <div 
            ...
            >
                ...
                >
                    <h1 
                    className="font-legendaire text-[8.3vw] bg-gradient-to-b from-[#FFD23F] to-[#FFA514] bg-clip-text text-transparent max-lg:text-[16.7vw] max-lg:text-center"
                    >
                        Materi
                    </h1>
                    <p className="font-publica-sans text-[1.7vw]/[2vw] text-[#FFE5C7] max-lg:text-[2.6vw]/[2.6vw] max- max-lg:text-center">
            ...
            <div
            className="w-[100vw] min-h-[30vw] flex gap-[1vw] overflow-x-auto hide-scrollbar whitespace-nowrap items-center z-[1] max-lg:hidden"
            >
                {
        ...
        <div
        className="w-full min-h-[65vw] flex items-center justify-center gap-[6.1vw] lg:hidden"
        >
